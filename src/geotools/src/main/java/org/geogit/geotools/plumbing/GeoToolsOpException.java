...
public class GeoToolsOpException extends RuntimeException {
    ...
    public enum StatusCode {
        ALL_AND_TABLE_DEFINED, DATASTORE_NOT_DEFINED, TABLE_NOT_DEFINED, NO_FEATURES_FOUND, TABLE_NOT_FOUND, UNABLE_TO_GET_NAMES, UNABLE_TO_GET_FEATURES, UNABLE_TO_INSERT, UNABLE_TO_ADD, CANNOT_CREATE_FEATURESTORE, UNCOMPATIBLE_FEATURE_TYPE, ALTER_AND_FORCE_DEFINED, ALTER_AND_ALL_DEFINED
    }
