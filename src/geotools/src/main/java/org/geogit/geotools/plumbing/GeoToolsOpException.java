...
public class GeoToolsOpException extends RuntimeException {
    ...
    public enum StatusCode {
        ALL_AND_TABLE_DEFINED, DATASTORE_NOT_DEFINED, TABLE_NOT_DEFINED, NO_FEATURES_FOUND, TABLE_NOT_FOUND, UNABLE_TO_GET_NAMES, UNABLE_TO_GET_FEATURES, UNABLE_TO_INSERT, UNABLE_TO_ADD, CANNOT_CREATE_FEATURESTORE, IMPORTING_MULTIPLE_TABLES_TO_SINGLE_FEATURE_TYPE, UNMATCHING_FEATURE_TYPES
    }
